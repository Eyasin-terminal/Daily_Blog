...
url: "https://<your-username>.github.io" # Replace <your-username> with your actual GitHub username (e.g., https://eyasin.github.io)
baseurl: "/Daily_Blog" # Repository subpath name for GitHub Pages
...
<body>
  ...
  <header class="site-header">
    <div class="container header-inner">
      ...
      <nav class="site-nav">
        <a class="nav-link" href="{{ "/" | relative_url }}">Archive</a>
        {% if site.author.linkedin %}
        <a class="nav-link" href="{{ site.author.linkedin }}" target="_blank" rel="noopener noreferrer">LinkedIn ↗</a>
        {% endif %}
      </nav>
    </div>
  </header>
  ...
  <footer class="site-footer">
    <div class="container footer-inner">
      ...
      <div class="footer-links">
        {% if site.author.linkedin %}
        <a class="footer-link" href="{{ site.author.linkedin }}" target="_blank" rel="noopener noreferrer">LinkedIn</a>
...
layout: default
title: "The Eyasin Arafath Brief"
---

<!-- Introduction Thesis Section -->
<section class="thesis-section">
  <h1 class="thesis-heading">The Eyasin Arafath Brief</h1>
  <p class="thesis-body">
    A daily synthesis of emerging concepts across economics, business strategy, and technology markets.
  </p>
  <div class="thesis-meta">
    <span>Focus: Economics, Strategy &amp; Tech Markets</span>
    <span class="meta-divider">•</span>
    <span>Daily Synthesis</span>
  </div>
</section>

<div class="section-label">Brief Index &amp; Archive</div>
