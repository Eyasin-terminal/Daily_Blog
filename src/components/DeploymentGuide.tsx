...
git push -u origin main`}</pre>
        ...
        <div className="bg-[#FFF8F0] border border-[#F5D0A9] p-4 text-xs text-[#7A4100]">
          ...
          <ol className="list-decimal pl-4 space-y-2 leading-relaxed">
            ...
            <li>
              <strong>Repository Name vs. <code className="bg-[#FFE8D6] px-1 font-mono">baseurl</code>:</strong>
              <br />
              If your repository is named <code className="bg-[#FFE8D6] px-1 font-mono">monograph</code> (e.g. <code className="bg-[#FFE8D6] px-1 font-mono">username.github.io/monograph</code>), open <code className="bg-[#FFE8D6] px-1 font-mono">_config.yml</code> and change <code className="bg-[#FFE8D6] px-1 font-mono">baseurl: ""</code> to <code className="bg-[#FFE8D6] px-1 font-mono">baseurl: "/monograph"</code> so CSS assets load properly.
            </li>
            <li>
