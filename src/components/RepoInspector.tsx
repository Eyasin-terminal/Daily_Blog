...
${post.content}`,
  ...
  const handleDownloadZip = async () => {
    ...
    try {
      ...
      zip.file(
        'README.md',
        `# Institutional Research Monograph (GitHub Pages + Jekyll Repository)

This repository contains the complete Jekyll static site structure for an **Institutional Research Monograph** site, tailored for Market Research & Business Intelligence Analysts.

## Quick Start on GitHub Pages

1. Create a new GitHub repository (e.g., \`monograph\` or \`username.github.io\`).
2. Extract all contents of this ZIP into your repository folder.
3. Commit and push to GitHub:
   \`\`\`bash
   git init
   git add .
   git commit -m "Initial monograph deployment"
   git branch -M main
